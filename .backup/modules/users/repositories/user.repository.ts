...
export interface IUserRepository {
  ...
  update(
    ...
    data: Partial<
      Pick<
        User,
        "displayName" | "bio" | "website" | "location" | "birthDate" | "preferences"
      >
    >
  ): Promise<User>;
...
export class SupabaseUserRepository implements IUserRepository {
    ...
    return {
      ...
      theme:
        obj.theme === "light" || obj.theme === "dark" || obj.theme === "auto"
          ...
          : base.theme,
      compactMode:
        typeof obj.compactMode === "boolean"
          ? obj.compactMode
          : base.compactMode,
      profilePublic:
        typeof obj.profilePublic === "boolean"
          ? obj.profilePublic
          : base.profilePublic,
      showEmail:
        typeof obj.showEmail === "boolean" ? obj.showEmail : base.showEmail,
      showStats:
        typeof obj.showStats === "boolean" ? obj.showStats : base.showStats,
      notifications: {
        ...base.notifications,
  ...
  private parseStats(raw: unknown): UserStats {
    ...
    return {
      ...
      achievementsUnlocked: num(
        obj.achievementsUnlocked,
